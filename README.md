...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `Insiares`, `scraper`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `project_title`, `project_description`
...
Project Link: [https://github.com/Insiares/scraper](https://github.com/Insiares/scraper)
